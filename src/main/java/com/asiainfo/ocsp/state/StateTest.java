package com.asiainfo.ocsp.state;
...
public class StateTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("bootstrap.servers", "ip:6667");

        Kafka inputKafka = new Kafka().properties(properties).version("universal").topic("bar");
        Schema inputSchema = new Schema()
                .field("s_string", Types.STRING())
                .field("s_int", Types.STRING())
                .field("s_long", Types.SQL_TIMESTAMP());
        ...
        Table midTable = input.select("s_string, s_int, s_long");
        ...
        DataStream<Row> stayTimeRow = keyedStream.map(new RichMapFunction<Row, Row>() {
            //            private ValueState<Row> stayAreaTime;
            ...
            public Row map(Row value) throws Exception {
                ...
                int areaFieldIndex = rowTypeInfo.getFieldIndex(areaKey);
